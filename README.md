...
<!-- instalacion de babel es una herramienta crear javascript moderno compatible con todo los navegadores .. npm install --save-dev @babel/core @babel/preset-env @babel/preset-react babel-loader  -->
